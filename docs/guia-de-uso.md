...
Última actualización: 2026-07-17 (orden manual arrastrando y carpetas en Notas/Snippets; snippets se insertan con `/` y se renombran con click; se quitaron insertar y etiquetar del snippet; mover con Alt+flechas ya no se frena en el borde del padre).
