...
try {
	...
	// 18. La mitad que faltaba de la mudanza. Las dos cuentas tienen una fila con
	...
	// 19. Restaurar un respaldo vacía `records` de quien llama y nada más. Las dos
	...
	// 20. Empezar de nuevo borra lo propio y nada de lo ajeno. Es la única puerta
	...
	console.log('\nCandado OK: las veinte pruebas pasaron.');
} finally {
