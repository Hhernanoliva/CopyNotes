				...
				<div class="flex flex-col gap-2">
					{#if !isTauriRuntime()}
						<!-- Google da la puerta, no la llave (spec 034). Va primero, y primero
						     ...
						     con contraseña queda como red. En la .app todavía no aparece —
						     abriría Google dentro de una ventana sin barra de direcciones y
						     sin camino de vuelta; eso es la fase 2. -->
						<button
							type="button"
